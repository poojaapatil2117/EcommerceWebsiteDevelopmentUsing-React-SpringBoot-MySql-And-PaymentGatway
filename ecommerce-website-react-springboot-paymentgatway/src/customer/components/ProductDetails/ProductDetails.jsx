            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">46763 Ratings</p>
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart}
                  variant="contained"
                  sx={{ px: "2rem", py: "1rem", bgcolor: "#9155fd", mt:"1rem"}}
                >
                  Add to Cart
                </Button>
              </form>
            ...
            <Grid container spacing={7} justifyContent={"space-between"}>
              ...
              <Grid item xs={5} justifyContent={"space-between"}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">46574 Ratings</p>
                </div>

                <Box className="mt-5 space-y-3" sx={{ width: 250 }}>
